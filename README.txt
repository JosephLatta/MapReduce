...
your servers to Addresses.txt before running the program. Type:
"cs3110 run controllerMain.ml <application name> <filename>" in your 
terminal to run the software. Our implentation only supports the passing
of a single file.
